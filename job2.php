...
<div class="container">
    <div class="wrap  mt-100" role="main">
        <header class="custom-flex">
            ...
            <div>
                <h1>Senior Website Development</h1>
        ...
        <div class="grid">
            <section class="card main">
                <h2>Job Summary</h2>
                <p class="">The Senior Website Developer will lead web development projects from concept to deployment,
                    ensuring high performance, scalability, security, and exceptional user experience. The role involves
                    collaborating with cross-functional teams, mentoring junior developers, and delivering robust
                    digital solutions across websites, web applications, and platform integrations.</p>


                <h2 class="mt-4">Key Responsibilities</h2>
                <ul>
                    <li>Build and maintain websites and web applications.</li>
                    <li>Convert designs into working web pages.</li>
                    <li>Write clean, efficient, and reusable code.</li>
                    <li>Manage backend logic, databases, and APIs.</li>
                    <li>Improve website speed, security, and SEO.</li>
                    <li>Fix bugs and troubleshoot issues.</li>
                    <li>Review code and guide junior developers.</li>
                    <li?>Work with design, marketing, and product teams.</li>
                        <li>Keep up with new tools and technologies.</li>
                </ul>


                <h2>Skills & Qualifications</h2>
                <div class="skills" aria-hidden="false">
                    <span class="skill">Strong knowledge of HTML, CSS, JavaScript.</span>
                    <span class="skill">Experience with React, Vue, Angular or similar frameworks.</span>
                    <span class="skill">Backend experience (Node.js, PHP, Python, etc.).</span>
                    <span class="skill">Understanding of databases and APIs.</span>
                    <span class="skill">Familiar with Git/version control.</span>
                    <span class="skill">Knowledge of website performance and security.</span>
                    <span class="skill">Problem-solving mindset.</span>
                    <span class="skill">Good communication and teamwork.</span>
                    <span class="skill">Leadership and mentoring ability.</span>
                </div>


                <div class="actions">
                    <button class="btn btn-outline-info mob_non tab-non" id="applyBtn" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop">Apply Now</button>
                </div>
                <!-- Modal -->
                                                ...
                                                <div id="skills-container">
                                                    ...
                                                    <div class="skill-row d-flex gap-2 mb-2">
                                                        <input type="text" class="form-control ca-two-border"
                                                            name="skill_name[]"
                                                            placeholder="Skill Name (e.g., HTML, CSS, JavaScript)"
                                                            required style="flex: 2;">
                                                        <input type="number" class="form-control ca-two-border"
                                                            name="skill_percentage[]" placeholder="% (e.g., 90)" min="0"
                                                            max="100" required style="flex: 1;">
                                                        <button type="button"
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    addSkillBtn.addEventListener('click', function() {
                        ...
                        skillRow.innerHTML = `
                <input type="text" class="form-control ca-two-border" name="skill_name[]" placeholder="Skill Name (e.g., HTML, CSS, JavaScript)" required style="flex: 2;">
