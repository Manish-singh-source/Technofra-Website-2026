    ...
    <div class="wrap  mt-100" role="main">
        ...
        <div class="grid">
            <section class="card main">
                <h2>Job Summary</h2>
                <p class="">We are looking for a Senior Social Media professional to lead our online presence, grow
                    engagement, and drive brand awareness. You will plan strategies, create campaigns, analyze
                    performance, and guide junior team members.</p>


                <h2 class="mt-4">Key Responsibilities</h2>
                <ul>
                    <li>Plan and execute social media strategies across platforms.</li>
                    <li>Create and manage content calendars.</li>
                    <li>Lead campaigns for brand awareness, leads, and engagement.</li>
                    <li>Monitor trends and adapt content accordingly.</li>
                    <li>Manage paid promotions and ad performance.</li>
                    <li>Track metrics and prepare performance reports.</li>
                    <li>Coordinate with design, content, and marketing teams.</li>
                    <li?>Respond to audience interactions and build community.</li>
                    <li>Mentor junior team members and review their work.</li>
                </ul>


                <h2>Skills & Qualifications</h2>
                <div class="skills" aria-hidden="false">
                    <span class="skill">Strong understanding of major platforms (Instagram, Facebook, LinkedIn, X, YouTube, etc.).</span>
                    <span class="skill">Experience in content planning and campaign management.</span>
                    <span class="skill">Knowledge of paid ads and targeting.</span>
                    <span class="skill">Ability to analyze insights and improve results.</span>
                    <span class="skill">Good copywriting and communication skills.</span>
                    <span class="skill">Creativity with a data-driven mindset.</span>
                    <span class="skill">Leadership and team collaboration.</span>
                    <span class="skill">Time management and multitasking.</span>
                </div>
